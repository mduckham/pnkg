...
| **NSW** | [Web Link](https://data.nsw.gov.au/data/dataset/geographical-name-register-of-nsw)         | [Official NSW place names gazetteer](https://proposals.gnb.nsw.gov.au/public/geonames/search) | [NSW.csv](data/NSW/NSW.csv)        | 13/10/25 |
...
| **QLD** | [Web Link](https://www.data.qld.gov.au/dataset/place-names-gazetteer-queensland-txt-file) | [Official QLD place names gazetteer](https://www.qld.gov.au/environment/land/title/place-names/search)           | [QLD.csv](data/QLD/QLD.csv) |  25/03/25 |
...
| **WA**  | [Web Link](https://catalogue.data.wa.gov.au/dataset/geographic-names-geonoma) | [Official WA place names gazetteer](https://catalogue.data.wa.gov.au/dataset/geographic-names-geonoma)           | [Available direct from Landgate](https://catalogue.data.wa.gov.au/dataset/geographic-names-geonoma)               | 25/03/25 |
...
<div align="center">
  <img src="doc/PlaceName_sde_process.png" alt="Alt text" style="width:95%;">
</div>
