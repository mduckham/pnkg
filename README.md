...
|         | DL          | (no?)                                                                                                                     |                |                       |            |
|         | API         | (Not checked)                                                                                                             |                |                       |            |
| **QLD** | DP          | [Downlload official QLD place names gazetteer](https://www.qld.gov.au/environment/land/title/place-names/search)                                                          | [QLD.csv](data/QLD/QLD.csv)    |         16/11/2024 |
|         | DL          | Request by email                                                                                                          |                |                       |            |
|         | API         | (Not checked)                                                                                                             |                |                       |            |
