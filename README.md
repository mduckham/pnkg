...
| Jursdiction    | Description | Link                                                                                                                      | Data in github |  Last Updated |
| ------- | ----------- | ------------------------------------------------------------------------------------------------------------------------- | -------------- |  ---------- |
| ACT     | DP          | -                                                                                                                         |                |                       | -          |
|         | DL          | -                                                                                                                         |                |                       |            |
...
|         | DL          | (no?)                                                                                                                     |                |                       |            |
|         | API         | (Not checked)                                                                                                             |                |                       |            |
| **QLD** | DP          | [Download official QLD place names gazetteer](https://www.qld.gov.au/environment/land/title/place-names/search)                                                          | [QLD.csv](data/QLD/QLD.csv)    |         20/12/2024 |
|         | DL          | Request by email                                                                                                          |                |                       |            |
|         | API         | (Not checked)                                                                                                             |                |                       |            |
